package com.cnkaptan.materialdesignexamples;
...
public class CircularRevealTransationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circular_reveal_transation);
        ...
        rv.setAdapter(new RecyclerView.Adapter<ViewHolder>() {
            ...
            public ViewHolder onCreateViewHolder(ViewGroup parent, int position) {
                return new ViewHolder(getLayoutInflater().inflate(R.layout.circular_reveal_list_item, parent, false));
            }
